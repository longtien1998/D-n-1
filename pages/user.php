                ...
                <div class="bg-white p-4 rounded-lg shadow-lg">
                    <div class="text-center">
                        <div class="profile-picture">
                            <img class="rounded-full border border-gray-100 shadow-sm" src="../content/images/face.png" alt="Profile picture of Sara Tancredi wearing sunglasses and a teal top" width="100" height="100">
                        </div>
                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="longtien1996@gmail.com">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="location" placeholder="Quảng Ngãi">
                                </div>
                                <div class="form-group col-md-6">
