<?php
$row = user_select_by_id($_SESSION["user"]);
$user = $_SESSION["user"];
$messagetong = '';
$message1 = '';
$message2 = '';
...
if (isset($_POST['luu']) && ($_POST['luu'])) {
    ...
    if ($uploadok == 0) {
        ...
        if (move_uploaded_file($_FILES["filetoUpload"]["tmp_name"], $target_file)) {
            ...
            $conn = connect_db();
            $query = "UPDATE user SET urlimage ='$path' WHERE tenKhachHang ='$user'";
            ...
            if ($result) {
                ...
                header('refresh:2;index.php?action=userkh');
            } else {
...
if (isset($_POST['save']) && ($_POST['save'])) {
    ...
    $conn = connect_db();
    $query = "UPDATE user SET hoTen='$fullname',tenKhachHang='$username',email='$email',sDT='$phone',matKhau='$password' WHERE tenKhachHang ='$user'";
        ...
        <div class="col-lg-8 ">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-lg border-success">
                        <div class="text-center">
                            ...
                            <h1 class="text-black-700 font-semibold mt-4"><?php echo $row['hoTen']; ?></h1>
                            ...
                            <form action="" method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="manhanvien" name="manhanvien" value="<?php echo $row['maKhachHang']; ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="username">Tên đăng nhập</label>
                                        <input type="text" class="form-control" name="username" id="username" value="<?php echo $row['tenKhachHang']; ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="full-name">Họ Và Tên</label>
                                        <input type="text" class="form-control" name="fullname" id="full-name" value="<?php echo $row['hoTen']; ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $row['sDT']; ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="phone">Số điện thoại</label>
                                        <input type="password" class="form-control" id="password" name="password" value="<?php echo $row['matKhau']; ?>" readonly>
                                    </div>
                                ...
                                <div class="text-center mt-4">
                                    <button type="button" class="btn btn-orange border-primary mx-2 " id="pass">Đổi mật khẩu</button>
